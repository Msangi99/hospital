                ...
                <div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                    ...
                    <div class="flex justify-center lg:justify-start">
                        <form method="POST" action="{{ route('locale.set') }}">
                            ...
                            <select name="locale" onchange="this.form.submit()" class="border border-neutral-300 dark:border-neutral-700 rounded-full px-3 py-1.5 text-[12px] font-extrabold bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100">
