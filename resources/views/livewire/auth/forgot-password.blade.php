    ...
    <div>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="mb-4 relative">
                ...
                <input type="email" name="email" value="{{ old('email') }}" placeholder="{{ __('authui.email_placeholder') }}" required autofocus class="w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-2xl outline-none focus:border-blue-500 transition font-semibold text-sm">
            </div>
