...
@component('layouts.role-dashboard', ['title' => __('roleui.sidebar_patients'), 'sidebarTitle' => $sidebarTitle])
    @slot('sidebar')
        ...
        <a href="{{ route('doctor.patients') }}" class="flex items-center gap-3 rounded-2xl px-4 py-3 font-black text-xs uppercase tracking-widest bg-white/10 hover:bg-white/15 transition">
